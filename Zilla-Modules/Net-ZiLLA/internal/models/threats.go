...
type ThreatAnalysis struct {
	...
	URLEnrichment   *URLEnrichment   `json:"url_enrichment"`

	AIResult        *shared_models.AIAnalysisResult    `json:"ai_result"`
	AIOrchestration *shared_models.OrchestrationResult `json:"ai_orchestration"`
...
// URLEnrichment provides detailed analysis of the URL structure
type URLEnrichment struct {
	TLDRisk          float64  `json:"tld_risk"`
	Entropy          float64  `json:"entropy"`
	HomographAttack  bool     `json:"homograph_attack"`
...
// Report represents a saved analysis report.
type Report struct {
...
// RedirectAnalysis aggregates metrics about a redirect chain.
type RedirectAnalysis struct {
	Hops           int `json:"hops"`
	UniqueDomains  int `json:"unique_domains"`
	ExternalLinks  int `json:"external_links"`
	InternalLinks  int `json:"internal_links"`
	SuspiciousURLs int `json:"suspicious_urls"`
}
